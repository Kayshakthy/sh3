...
namespace ArrisTest
{
    public partial class Form_New_Port_Forwarding
    {
        /// <summary>
       ...
       // Report.Info("enable/disable Status : "+argument2);
		...
		/** added on 15/01/2018 */
        public void Port_Forwarding_Rule_Details(string argument1, string argument2, string argument3, string argument4, string argument5, string argument6, string argument7)
        {
        	Report.Info("Port Forwarding Rule Details :" + argument1 + ":"+ argument2 + ":"+ argument3 + ":"+ argument4 + ":"+ argument5 + ":"+ argument6 + ":"+ argument7);       
        }
