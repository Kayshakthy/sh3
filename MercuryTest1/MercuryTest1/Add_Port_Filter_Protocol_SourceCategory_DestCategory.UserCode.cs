...
namespace ArrisTest
{
    public partial class Add_Port_Filter_Protocol_SourceCategory_DestCategory
    {
        /// <summary>
			...
			{		//TO enable/disable  PORT TRIGGER RULE
		     		...
		     		if(optTag.InnerText == argument2){
		    			...
		    			if(argument2=="single"){	// if it is single source Source IP
		    				TestSuite.Current.GetTestCase("Input_Single_SourceIP").Checked = true;
		    				TestSuite.Current.GetTestCase("Input_Range_SourceIP").Checked = false;
		    			}else if(argument2=="range"){	//if it is  range source IP
		    				
		    				TestSuite.Current.GetTestCase("Input_Range_SourceIP").Checked = true;
		    				TestSuite.Current.GetTestCase("Input_Single_SourceIP").Checked = false;
		    			}
		    			break;
		     		}
			...
			{		//TO enable/disable  PORT TRIGGER RULE
		     		...
		     		if(optTag.InnerText == argument3){
		    			...
		    			if(argument3=="single"){	// if it is single destination Source IP
		    				TestSuite.Current.GetTestCase("Input_Single_DestIP").Checked = true;
		    				TestSuite.Current.GetTestCase("Input_Range_DestIP").Checked = false;
		    			}else if(argument3=="range"){	//if it range destination IP
		    				
		    				TestSuite.Current.GetTestCase("Input_Range_DestIP").Checked = true;
		    				TestSuite.Current.GetTestCase("Input_Single_DestIP").Checked = false;
		    			}
		    			break;
		     		}
