...
namespace ArrisTest
{
    public partial class Disable_Add__Device_To_MAC_List_5GHz_Primary
    {
        /// <summary>
        ...
        public void Choose_Attached_Devices_To_Disable_Add_5GHz_Primary(string argument1, string argument2, string argument3, string argument4, string argument5, string argument6, string argument7)
        {
        	//choose device - 5GHz-to Disable
            ...
            //Count the total no of IPv4 port Filter rules (rows)
	     	...
	     	if(rulesCount == 0){
			        		...
			        		//Report.Info("span count :  "+spanVals.Count);
			        		 foreach(SpanTag spanVal in spanVals){
			        			...
			        			if(macAddress == macAddress1){
				        			...
				        			// check WIfi Freq validation before adding to the MAC List//
				...
				if(!isMatch){
					...
					TestSuite.Current.GetTestCase("Add_Disable_Device_To_MAC_Address_List1").Checked = false;	//Add_Device_To_MAC_Address_List
				}else{
					TestSuite.Current.GetTestCase("Add_Disable_Device_To_MAC_Address_List1").Checked = true;	//Add_Device_To_MAC_Address_List
