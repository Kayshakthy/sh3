...
namespace ArrisTest
{
    public partial class Allow_Add_Device_To_Mac_List_5GHz_Prmy
    {
        /// <summary>
        ...
        public void Choose_Attached_Devices_To_Add_5GHz_Primary(string argument1, string argument2, string argument3, string argument4, string argument5, string argument6, string argument7)
        {
        	...
        	Report.Info("---Finding the webDocument ---");
        	...
        	//
        	Report.Info("---Going to Find the AttachedDevicesTable ---");
            ...
            //Count the total no of IPv4 port Filter rules (rows)
	     	...
	     	if(rulesCount == 0){
	     		...
	     		Report.Failure("MAC Filter ","There are no devices attached with this router !!");
			    ...
			    {  
			        		...
			        		//Report.Info("span count :  "+spanVals.Count);
			        		 foreach(SpanTag spanVal in spanVals){
			        			...
			        			if(macAddress == macAddress1){
									...
									*/
				        			string rst = "The following device is currently attached to the router !!!";
									Report.Success(rst);
			      ...
			      if(isMatch){
			        	//check if Wifi Frequency is 5GHz  and click the radio button
			        	Report.Info("Wifi_Freq",Wifi_Freq);
			        	if(Wifi_Freq.Trim()=="WI-FI 5G"){
			        		...
			        		Report.Info("This device is NOT connected to WI-FI 5G");
			        		break;
			        	}
				    	//break;
				  }
				...
				if(!isMatch){
					...
					TestSuite.Current.GetTestCase("Add_Device_To_MAC_Address_List1").Checked = false;	//Add_Device_To_MAC_Address_List1
				
				}else{
					TestSuite.Current.GetTestCase("Add_Device_To_MAC_Address_List1").Checked = true;	//Add_Device_To_MAC_Address_List1
					
				}			    
	     	}	//end of if-else
        }

        public void Select_Attached_5GHz_Primary_Devices_To_Add(string argument1, string argument2, string argument3, string argument4, string argument5, string argument6, string argument7)
        {
        	////choose device from the attached list
			//This method is to select any MAC filter rules to delete
        	//argument1 - MAC Address0, argument2- MAC Address1
