...
namespace ArrisTest
{
    public partial class View_Downstream_Bonded_Channels
    {
        /// <summary>
        ...
        public void View_DownstreamBonded_Channels()
        {
        	Delay.Seconds(30);
        	...
        	TableTag myTable = webDocument.FindSingle("/dom[@domain='192.168.0.1']//table[#'DownstremChannel']"); 
	     	...
	     	Report.Screenshot("DownstreamBonded_Channels Status",myTable.Element);
	     	Delay.Seconds(2);        	
        }
