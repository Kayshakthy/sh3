...
namespace ArrisTest
{
    public partial class Guest_5GHz_Invalid_Password_Validation
    {
        /// <summary>
        ...
        public void Validate_Guest_5GHz_Invalid_Pass(string argument1)
        {
           ...
           Validate.Attribute(repo.WebDocument19216801.PasstextWifiInfo, "InnerText", "invalid","{3}",false);          	
        }
