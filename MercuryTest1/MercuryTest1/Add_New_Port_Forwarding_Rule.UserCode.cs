...
namespace ArrisTest
{
    public partial class Add_New_Port_Forwarding_Rule
    {
        /// <summary>
        ...
        public void Validate_Text65535()
        {
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (WindowText='Table FWVirtSrvTable is full') on item 'MessageFromWebpage.Text65535'.", repo.MessageFromWebpage.Text65535Info);
            //Validate.Attribute(repo.MessageFromWebpage.Text65535Info, "WindowText", "Table FWVirtSrvTable is full");
            bool rst = Validate.Attribute(repo.MessageFromWebpage.Text65535Info, "WindowText", "Table FWVirtSrvTable is full","{3}",true);
            Report.Info("rst",rst.ToString());
        }		//end of function Validate_New_PortForwardingRule()
