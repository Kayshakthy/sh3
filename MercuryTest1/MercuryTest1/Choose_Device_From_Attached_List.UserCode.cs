...
namespace ArrisTest
{
    public partial class Choose_Device_From_Attached_List
    {
        /// <summary>
        ...
        public void ChooseDeviceFromAttachedDevicesList(string argument1, string argument2, string argument3, string argument4, string argument5, string argument6)
        {
            ...
            //Count the total no of IPv4 port Filter rules (rows)
	     	...
	     	if(rulesCount == 0){
			    ...
			    string macAddress="",macAddress1="", devName="";
				...
				if(!isMatch){
					...
					TestSuite.Current.GetTestCase("Add_Attached_Device_To_MAC_Filter_list").Checked = false;	//Add_Attached_Device_To_MAC_Filter_list
				
				}else{
					TestSuite.Current.GetTestCase("Add_Attached_Device_To_MAC_Filter_list").Checked = true;	//Add_Attached_Device_To_MAC_Filter_list
				}
	     	}
        }
    }
