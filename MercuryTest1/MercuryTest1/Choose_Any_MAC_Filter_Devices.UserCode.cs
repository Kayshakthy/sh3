...
namespace ArrisTest
{
    public partial class Choose_Any_MAC_Filter_Devices
    {
        /// <summary>
        ...
        public void Choose_Any_MAC_Filtering_Device_To_Delete(string argument1, string argument2, string argument3, string argument4, string argument5, string argument6)
        {
        	//choose any device based on Device name and MAC address values
        	
        	//This method is to select any MAC filter rules to delete
        	//argument1 - MACAddress_0, argument2- MACAddress_1
        	//argument3 - MACAddress_2, argument4 - MACAddress_3
        	//argument5 - MACAddress_4, argument6 -MACAddress_5
			        ...
			        foreach(TdTag MacCol in cols){
			        	...
			        	if(colNum == 2){
			        		...
			        		if(macAddress == macAddress1){
			        			...
			        			Report.Info("----------------- Rules Matches !!! ------");
			        			String newPath = "";															
			        			newPath = MacCol.GetPath() + "/input[#'macAddressFilterTable-Delete-"+delCheck+"']";	//fmChbx-macAddressFilterTable-Delete-0, macAddressFilterTable-Delete-0
			        			Report.Info("--------- newPath orginal ---->> " + newPath);
			        			
//			        			'/dom[@page='' and @path='/' and @browsername='IE' and @pageurl='http://192.168.100.1/?wifi_settings&mid=WirelessPrimary']//tbody[#'macAddressFilterTable_body']/tr[1]/td[3]/" + "/input[#'macAddressFilterTable-Delete-"+delCheck+"']";
//			        			newPath = "/dom[@page='' and @path='/' and @browsername='IE' and @pageurl='http://192.168.0.1/?wifi_settings&mid=WirelessPrimary']/"+ "/input[#'macAddressFilterTable-Delete-"+delCheck+"']";	
