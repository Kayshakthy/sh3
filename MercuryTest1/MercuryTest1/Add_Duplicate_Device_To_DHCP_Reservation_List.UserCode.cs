...
namespace ArrisTest
{
    public partial class Add_Duplicate_Device_To_DHCP_Reservation_List
    {
        /// <summary>
        ...
        public void Validate_ErrTipMacAddress()
        {
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'WebDocumentIE.ErrTipMacAddress'.", repo.WebDocumentIE.ErrTipMacAddressInfo);
            Validate.Exists(repo.WebDocumentIE.ErrTipMacAddressInfo);
        }

        public void Validate_ErrTipMacAddress1()
        {
            //Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'WebDocumentIE.ErrTipMacAddress'.", repo.WebDocumentIE.ErrTipMacAddressInfo);
            string rstStr = "The Device with MAC Address is already exists " ;
            Report.Info("Validation",rstStr);
           // Report.Screenshot(repo.WebDocument19216801.IPv4SrcSingle3.Element,true);
            Report.Screenshot(repo.WebDocument19216801.AttachedDevicesTable.Element,true);
            
            Validate.Exists(repo.WebDocumentIE.ErrTipMacAddressInfo,"Duplicate Device",true);
