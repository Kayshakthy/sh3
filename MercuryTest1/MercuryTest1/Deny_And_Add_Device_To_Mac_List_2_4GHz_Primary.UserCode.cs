...
namespace ArrisTest
{
    public partial class Deny_And_Add_Device_To_Mac_List_2_4GHz_Primary
    {
        /// <summary>
        ...
        public void Choose_Attached_Devices_To_Deny_Add_2_4GHz_Primary(string argument1, string argument2, string argument3, string argument4, string argument5, string argument6, string argument7)
        {
            ...
            //Count the total no of IPv4 port Filter rules (rows)
	     	...
	     	if(rulesCount == 0){
			        	...
			        	if(colNum == 1){
			        		...
			        		*/
							if(MacCol.InnerText.StartsWith("No attached devices.")){	//9.1.116v(R3.7.1)
								...
								TestSuite.Current.GetTestCase("Add_Deny_Device_To_MAC_Address_List").Checked = false;
								//isRuleExist=false;
								return;
								//break;
			        		}else{
			        		...
			        		//Report.Info("span count :  "+spanVals.Count);
			        		 foreach(SpanTag spanVal in spanVals){
			        			...
			        			if(macAddress == macAddress1){
									...
									*/
				        			string rst = "The following device is added to MACFilter_Filtering rule !!!";
									Report.Success(rst);
				...
				if(!isMatch){
					...
					TestSuite.Current.GetTestCase("Add_Deny_Device_To_MAC_Address_List").Checked = false;	//Add_Deny_Device_To_MAC_Address_List
				
				}else{
					TestSuite.Current.GetTestCase("Add_Deny_Device_To_MAC_Address_List").Checked = true;	//Add_Deny_Device_To_MAC_Address_List
