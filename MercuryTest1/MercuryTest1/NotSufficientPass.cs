...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The NotSufficientPass recording.
    /// </summary>
    [TestModule("9696b0d7-bb4d-4b62-b135-c709881c66f3", ModuleType.Recording, 1)]
    public partial class NotSufficientPass : ITestModule
    {
        /// <summary>
        ...
        static NotSufficientPass instance = new NotSufficientPass();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public NotSufficientPass()
        {
        }
        ...
        /// </summary>
        public static NotSufficientPass Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'aMmInOtE5t' with focus on 'WebDocument19216801.Passphrase'.", repo.WebDocument19216801.PassphraseInfo, new RecordItemIndex(4));
